    ...
    <main id="dining">
        ...
        <article>
                ...
                <figure class="specialityEats">
                    ...
                    <figure class="specialityEats">
                        <img class="speciality" src="assets/images/harmonyBakery.jpg" alt="Photo of the exterior of local vegan bakery Harmony's Bakery">
                        <figcaption>Harmony Bakery: 3446 Chestnut Ave,Baltimore, MD 21211</figcaption>
                    </figure>

                    <figure class="specialityEats">
                        <img class="speciality" src="assets/images/landOfKush.jpg" alt="Photo of local vegan resturant Land of Kush">
                        <figcaption>Land of Kush: 840 N Eutaw St, Baltimore,MD 21201</figcaption>
                    </figure>
