...
?>
    ...
    <main id="art">
        ...
        <article>
            <section>
                <p>Baltimore is not just only talented and experienced in a diverse sound set, but in the visual arts as well. A city built on creativity where creative expression is a method of escape for many, there are a plethora of local artists across the visual arts disciplines that have made a name for themselves. The importance of arts is even reinforced within the Baltimore City Public School System and various non-profit organizations that teach the arts to school-aged students. Across the city, there are many schools dedicated to the arts specifically, for example, Baltimore Design School and Baltimore School for the Arts, the top two arts high schools in the city where students can flex and expand their knowledge in their respective creative disciplines.</p>
            ...
            <section>
                <figure>
                    ...
                    <h3>The Station North-Arts District</h3>
                    ...
                    Visit over the summer and you'll get to experience all of the wonderful art/culture-related festivals hosted in the district such as Pride, Trans Pride Parade, and ArtScape: a festival that promotes art and culture through performances, art sales, creative workshops and more.
                    </figcaption>
                </figure>
<!-- add in portion for wide angle -->
                <figure id="graffiti">
                    ...
                    <figcaption> Located within the Station North Art District, at 
                        A place where graffiti, something that is commonly frowned upon, is welcomed with open arms. Artists come and draw whatever their heart desires at their leisure, so the alley never looks the same for too long. Attached is the Graffiti Warehouse, which is full of amazing art pieces from artists around the city.</figcaption>
                </figure>
            </section>
        </article>
    </main>
